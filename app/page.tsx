...
import { WhatYouMissingSection } from "./WhatYouMissingSection";
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]" data-theme="light">
      ...
      <main className="flex flex-col gap-16 px-4 sm:gap-20 sm:px-6">
        ...
        <section className="banner-hero relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 py-20 text-center">
          ...
          <div className="relative z-10 mx-auto max-w-4xl">
            ...
            <p className="mx-auto mt-8 max-w-lg text-lg leading-relaxed text-slate-200">
              Answer 12 quick questions, see your matched schemes, then save or add more details. One dashboard. No jargon.
            </p>
            <div className="mt-12">
              <Link
                href="/eligibility"
        ...
        <section id="why" className="flex flex-col items-center justify-center rounded-2xl bg-[var(--card)] py-16 sm:py-20 sm:px-6">
          <div className="mx-auto max-w-4xl px-4 text-center">
            ...
            <p className="mx-auto mt-4 text-[var(--muted)]">
              One two-step questionnaire: see your matches after the first round, then optionally complete the full form. One dashboard with schemes that match your business.
            </p>
          </div>
        </section>

        <WhatYouMissingSection />

        {/* ——— Testimonials ——— */}
        <section className="flex flex-col items-center justify-center rounded-2xl bg-[var(--card)] py-16 sm:py-20 sm:px-6">
        ...
        {/* ——— How it works + CTA ——— */}
        <section id="how-it-works" className="flex flex-col items-center justify-center rounded-2xl bg-[var(--background)] py-16 sm:py-20 sm:px-6">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <div className="mt-20 grid gap-12 sm:grid-cols-3 sm:gap-8">
              {[
                { n: "1", title: "Answer 12 quick questions", body: "Legal status, turnover, sector, location, support needed — we match you to the right schemes." },
                { n: "2", title: "See your matches (or continue)", body: "Get a list of matched schemes right away. Save and verify email, or continue with the full questionnaire." },
                { n: "3", title: "Apply with confidence", body: "Sign in via the link we send, open your dashboard, and start applications with a clear document list." },
              ].map((item) => (
      ...
      <footer className="mt-4 rounded-t-2xl bg-[var(--card)] py-12">
